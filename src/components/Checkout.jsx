                    ...
                    orderId ? (
                        <section className="checkout-content">
                            <div className="form-top">
                                <h3 className="form-title">Gracias por tu compra 🙌🏼</h3>
                                <p className="form-copy">El número de pedido es: {orderId}</p>
                            </div>
                        </section>)
                        ...
                        : (
                            <section className="checkout-content">
                                <div className="form-top">
                                    <h4 className="form-title">Estás a un paso de tus productos 🙌🏼</h4>
                                    <p className="form-copy">Completa el formulario con tus datos para finalizar la compra</p>
                                </div>
